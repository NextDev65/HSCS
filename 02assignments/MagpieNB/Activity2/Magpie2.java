...
public class Magpie2
{
	...
	public String getResponse(String statement)
	{
		...
		else if (statement.indexOf("Hitch") == 0)
		{
			...
			else response = "They sounds like an amazing teacher.";
		}
		else if (statement.indexOf("Joel") == 0 || statement.indexOf("joel") == 0)
		{
			response = "Oh, you know Joel. Your IQ has notably decreased.";
		}
		...
		{
			response = "Yes, I believe this is Computer Science.";
		}
		else
		{
